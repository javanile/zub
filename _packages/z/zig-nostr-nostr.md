...
date: 2026-07-22
category: networking
updated_at: 2026-07-22T11:15:14+00:00
last_sync: 2026-07-22T11:15:14Z
package_kind: hybrid
has_library: true
has_binary: true
...
> **Status: pre-alpha (`v0.3.7`).** The library core, transport, local-first
...
```sh
zig fetch --save https://github.com/zig-nostr/nostr/archive/refs/tags/v0.3.7.tar.gz
```
