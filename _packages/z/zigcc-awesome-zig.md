---
title: awesome-zig
description: A collaborative list of awesome Zig libraries and resources.
license: CC0-1.0
author: zigcc
author_github: zigcc
repository: https://github.com/zigcc/awesome-zig
keywords:
  - andrew-kelley
  - awesome
  - awesome-list
  ...
  - mach
date: 2026-07-03
updated_at: 2026-07-03T09:24:31+00:00
last_sync: 2026-07-03T09:24:31Z
...
permalink: /packages/zigcc/awesome-zig/
---
...
- [zigtools/zls](https://github.com/zigtools/zls) - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
- [zed-extensions/Zig](https://github.com/zed-extensions/zig) - Zig extension for Zed editor.
...
- [Getzig](https://github.com/matklad/hello-getzig) - An idea for a Zig version manager along the lines of gradle wrapper.
...
- [dweiller/zimalloc](https://github.com/dweiller/zimalloc) - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc).
...
- [g41797/syslog](https://github.com/g41797/syslog) - A [syslog](https://en.wikipedia.org/wiki/Syslog) RFC5424 client library.
...
- [vi/zigmkv](https://github.com/vi/zigmkv) - A (WIP) Matroska/webm (mkv) parser in Zig.
...
- [peymanmortazavi/csv-zero](https://github.com/peymanmortazavi/csv-zero) - Zero allocation, SIMD-accelerated CSV iterator and emitter for Zig.
- [OrlovEvgeny/serde.zig](https://github.com/OrlovEvgeny/serde.zig) - Comptime serialization framework for Zig supporting JSON, MessagePack, TOML, YAML, ZON, and CSV.
...
- [mitchellh/libxev](https://github.com/mitchellh/libxev) - A cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
- [neurocyte/thespian](https://github.com/neurocyte/thespian) - An actor library for Zig, C & C++ applications.
...
- [tralamazza/embedded_zig](https://github.com/tralamazza/embedded_zig) - A minimal Zig embedded ARM example (STM32F103 blue pill).
...
- [fengb/fundude](https://github.com/fengb/fundude) - Gameboy emulator: Zig -> WebAssembly.
...
- [g41797/beanstalkz](https://github.com/g41797/beanstalkz) - Thread-safe client library for [beanstalkd](https://pmatseykanets.github.io/beanstalkd-docs/), a queue for background job processing.
...
- [wazm](https://github.com/fengb/wazm) - WebAssembly Zig Machine.
...
- [zigwasm/wasm-zig](https://github.com/zigwasm/wasm-zig) - Common WebAssembly runtime binding to C API.
...
- [hexops/mach-gpu](https://github.com/hexops/mach-gpu) - Provides a truly cross-platform graphics API for Zig (desktop, mobile, and web) with unified low-level graphics & compute backed by Vulkan, Metal, D3D12, and OpenGL (as a best-effort fallback).
...
- [ashpil/moonshine](https://github.com/ashpil/moonshine) - A general purpose ray traced renderer built with Zig + Vulkan.
...
- [Thomvanoorschot/zignite](https://github.com/Thomvanoorschot/zignite) - Simple cross platform rendering engine able to compile to WebAssembly with WebWorkers support.
...
- [Mach](https://github.com/hexops/mach) - A game engine & graphics toolkit for the future. machengine.org.
...
- [ExpidusOS/zig-flutter](https://github.com/ExpidusOS/zig-flutter) - Flutter with Zig.
...
- [libz](https://github.com/andrewrk/libz) - Library zlib with the build system replaced by Zig.
- [libmp3lame](https://github.com/andrewrk/libmp3lame) - Library libmp3lame with the build system replaced by Zig.
- [libvorbis](https://github.com/andrewrk/libvorbis) - Library libvorbis with the build system replaced by Zig.
- [libogg](https://github.com/andrewrk/libogg) - Library libogg with the build system replaced by Zig.
...
- [libebur128](https://github.com/andrewrk/libebur128) - Library libebur128 with the build system replaced by Zig.
- [pulseaudio](https://github.com/andrewrk/pulseaudio) - Library pulseaudio with the build system replaced by Zig.
- [libchromaprint](https://github.com/andrewrk/libchromaprint) - Library chromaprint with the build system replaced by Zig.
- [libxlsxwriter](https://github.com/jmcnamara/libxlsxwriter) - A C library for creating Excel XLSX files, build system replaced by Zig.
- [raylib](https://github.com/raysan5/raylib/) - A simple and easy-to-use library to enjoy videogames programming.
- [openssl](https://github.com/kassane/openssl-zig) - TLS/SSL and crypto library (uses Zig Build).
- [wolfssl](https://github.com/kassane/wolfssl) - Library WolfSSL Using Zig Build.
...
- [json](https://github.com/kassane/json) - Library JSON for Modern C++ (uses Zig build-system).
- [context](https://github.com/kassane/context) - Library `boost.context` using Zig build.
...
- [asio](https://github.com/kassane/asio) - The Asio C++ Library with Zig build-system.
