---
title: zig-webui
description: Use any web browser or WebView as GUI, with Zig in the backend and modern web technologies in the frontend, all in a lightweight portable library.
license: MIT
author: webui-dev
author_github: webui-dev
repository: https://github.com/webui-dev/zig-webui
keywords:
  - cross-platform-gui
  - gui
  - gui-library
...
permalink: /packages/webui-dev/zig-webui/
---
