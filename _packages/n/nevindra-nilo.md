---
title: nilo
description: "HTTP server, Postgres, config and password hashing for Zig 0.16. A plain function is a route: typed params, 404s and an OpenAPI document all come from its signature at compile time. One allocation per request."
license: MIT
author: nevindra
...
date: 2026-09-06
category: tooling
updated_at: 2026-09-06T13:04:05+00:00
last_sync: 2026-09-06T13:04:05Z
package_kind: hybrid
has_library: true
has_binary: true
has_distributable_binary: true
binary_count: 15
distributable_binary_count: 15
...
Nine modules. The biggest one is an HTTP server, but the server is not the
