---
title: nilo
description: "Ten modules for Zig 0.16: an HTTP server, Postgres and SQLite, S3, an HTTP client, JWT, cache, config, password hashing. A plain function is a route, a plain struct is a table. Typed params, the 404, the OpenAPI document and the SQL all come from that while compiling. One allocation per request."
license: MIT
author: nevindra
...
date: 2026-09-12
category: tooling
updated_at: 2026-09-12T13:25:49+00:00
last_sync: 2026-09-12T13:25:49Z
package_kind: hybrid
has_library: true
has_binary: true
has_distributable_binary: true
binary_count: 16
distributable_binary_count: 16
...
<p align="center">
  ...
  <a href="./refusals/README.md"><img alt="231 refusals" src="https://img.shields.io/badge/mistakes%20refused%20while%20compiling-231-e05d44?style=flat-square"></a>
  <a href="./docs/adr/"><img alt="190 ADRs" src="https://img.shields.io/badge/decisions%20on%20file-190-6b7280?style=flat-square"></a>
...
| **231 refusals** | mistakes that stop the build with a sentence nilo wrote, held in place by six build steps. |
...
So this repository tests its error messages. There are **231 programs in it that
...
files, errors, settings, background work — then one page for each of the other
modules, [nine of them](./docs/guide/sql/README.md) for the database — then
testing, OpenAPI, metrics, deploying.
