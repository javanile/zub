...
repository: https://github.com/mnemnion/ohsnap
keywords:
  - snapshot-testing
  - test
  - testing-library
...
permalink: /packages/mnemnion/ohsnap/
---
...
```sh
zig fetch --save "https://github.com/mnemnion/ohsnap/archive/refs/tags/v0.5.1.tar.gz"
```
...
test "snap something" {
    ...
    // Or pass your own `pretty.Options` to `ohsnap.OhSnap(...)`.
