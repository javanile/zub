---
title: swerver
description: A zero-copy, zero-allocation HTTP server written in pure Zig.
license: MIT
author: justinGrosvenor
author_github: justinGrosvenor
repository: https://github.com/justinGrosvenor/swerver
keywords:
  - epoll
  - event-loop
  - high-performance
...
permalink: /packages/justinGrosvenor/swerver/
---
